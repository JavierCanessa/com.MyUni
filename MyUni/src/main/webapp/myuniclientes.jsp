            ...
            <div class="modal-body">
                <form id="formularioModificar">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="celular" name="celular" required pattern="[0-9]+" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="pasaporte" name="pasaporte" required pattern="[0-9]+" readonly>
                        <small class="form-text text-muted">Ingrese solo números.</small>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="proceso_<%= proceso.getId()%>" name="procesos" value="<%= proceso.name()%>" disabled>
